                        ...
                        <div className="row">
                            <div className="col-md-8">
                                ...
                                <label className="checkout-label">
                                    <input ref={register} type="checkbox" name="investor_exit" defaultChecked={investorExit().includes('I1')}
                                ...
                                <label className="checkout-label">
                                    <input ref={register} type="checkbox" name="investor_exit" defaultChecked={investorExit().includes('I2')}
                                ...
                                <label className="checkout-label">
                                    <input ref={register} type="checkbox" name="investor_exit" defaultChecked={investorExit().includes('I3')}
                                ...
                                <label className="checkout-label">
                                    <input ref={register} type="checkbox" name="investor_exit" defaultChecked={investorExit().includes('I4')}
                                ...
                                <label className="checkout-label">
                                    <input ref={register} type="checkbox" name="investor_exit" defaultChecked={investorExit().includes('I5')}
                                ...
                                <label className="checkout-label">
                                    <input ref={register} type="checkbox" name="investor_exit" defaultChecked={investorExit().includes('I6')}
                                ...
                                <label className="checkout-label">
                                    <input ref={register} type="checkbox" name="investor_exit" defaultChecked={investorExit().includes('I7')}
                                ...
                                <label className="checkout-label">
                                    <input ref={register} type="checkbox" name="investor_exit" defaultChecked={investorExit().includes('I8')}
                                ...
                                <label className="checkout-label">
                                    <input ref={register} type="checkbox" name="investor_exit" defaultChecked={investorExit().includes('I9')}
